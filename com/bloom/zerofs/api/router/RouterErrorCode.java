 ...
 */
package com.bloom.zerofs.api.router;
...
public enum RouterErrorCode {
  ...
  /**
   * Insufficient Amber DataNodes could be contacted to successfully complete an operation. The caller should retry the
   ...
   * {@link Router#putBlob(com.bloom.zerofs.messageformat.BlobProperties, byte[], ReadableStreamChannel)}
  ...
  BadInputChannel,
  /**
   * Insufficient capacity available in Amber for object to be stored.
   */
