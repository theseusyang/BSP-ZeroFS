...
public class AdminConfig {
  ...
  @Default("com.bloom.zerofs.admin.AdminIdConverterFactory")
  ...
  @Default("com.bloom.zerofs.admin.AdminSecurityServiceFactory")
  ...
  public AdminConfig(VerifiableProperties verifiableProperties) {
    ...
    adminIdConverterFactory = verifiableProperties
        .getString("admin.id.converter.factory", "com.bloom.zerofs.admin.AdminIdConverterFactory");
    adminSecurityServiceFactory = verifiableProperties
        .getString("admin.security.service.factory", "com.bloom.zerofs.admin.AdminSecurityServiceFactory");
