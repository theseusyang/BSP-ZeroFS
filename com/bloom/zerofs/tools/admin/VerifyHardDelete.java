  ...
  private long getOffsetFromCleanupToken(File cleanupTokenFile)
    ...
    if (cleanupTokenFile.exists()) {
      ...
      try {
        ...
        StoreKeyFactory storeKeyFactory = Utils.getObj("com.bloom.zerofs.commons.BlobIdFactory", map);
        FindTokenFactory factory = Utils.getObj("com.bloom.zerofs.store.StoreFindTokenFactory", storeKeyFactory);
