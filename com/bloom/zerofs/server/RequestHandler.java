...
import com.bloom.zerofs.api.server.EmptyRequest;
...
public class RequestHandler implements Runnable {
  ...
  private final AmberRequests requests;
  private Logger logger = LoggerFactory.getLogger(getClass());

  public RequestHandler(int id, RequestResponseChannel requestChannel, AmberRequests requests) {
    this.id = id;
...
class RequestHandlerPool {
  ...
  public RequestHandlerPool(int numThreads, RequestResponseChannel requestResponseChannel, AmberRequests requests) {
