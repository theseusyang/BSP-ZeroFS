 ...
 */
package com.bloom.zerofs.coordinator;
...
import com.bloom.zerofs.api.coordinator.CoordinatorError;
import com.bloom.zerofs.messageformat.MessageFormatErrorCodes;
...
public class CoordinatorMetrics {
  ...
  private final Counter AmberUnavailableError;
  ...
  public CoordinatorMetrics(ClusterMap clusterMap, final boolean isCrossDatacenterCallsEnabled) {
    ...
    putBlobOperationLatencyInMs =
        registry.histogram(MetricRegistry.name(AmberCoordinator.class, "putBlobOperationLatencyInMs"));
    deleteBlobOperationLatencyInMs =
        registry.histogram(MetricRegistry.name(AmberCoordinator.class, "deleteBlobOperationLatencyInMs"));
    getBlobPropertiesOperationLatencyInMs =
        registry.histogram(MetricRegistry.name(AmberCoordinator.class, "getBlobPropertiesOperationLatencyInMs"));
    getBlobUserMetadataOperationLatencyInMs =
        registry.histogram(MetricRegistry.name(AmberCoordinator.class, "getBlobUserMetadataOperationLatencyInMs"));
    getBlobOperationLatencyInMs =
        registry.histogram(MetricRegistry.name(AmberCoordinator.class, "getBlobOperationLatencyInMs"));
    operationRequestQueuingTimeInMs =
        registry.histogram(MetricRegistry.name(AmberCoordinator.class, "operationRequestQueuingTimeInMs"));

    putBlobOperationRate = registry.meter(MetricRegistry.name(AmberCoordinator.class, "putBlobOperationRate"));
    deleteBlobOperationRate = registry.meter(MetricRegistry.name(AmberCoordinator.class, "deleteBlobOperationRate"));
    getBlobPropertiesOperationRate =
        registry.meter(MetricRegistry.name(AmberCoordinator.class, "getBlobPropertiesOperationRate"));
    getBlobUserMetadataOperationRate =
        registry.meter(MetricRegistry.name(AmberCoordinator.class, "getBlobUserMetadataOperationRate"));
    getBlobOperationRate = registry.meter(MetricRegistry.name(AmberCoordinator.class, "getBlobOperationRate"));
    operationExceptionRate = registry.meter(MetricRegistry.name(AmberCoordinator.class, "operationExceptionRate"));

    putBlobError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "putBlobError"));
    deleteBlobError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "deleteBlobError"));
    getBlobPropertiesError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "getBlobPropertiesError"));
    getBlobUserMetadataError =
        registry.counter(MetricRegistry.name(AmberCoordinator.class, "getBlobUserMetadataError"));
    getBlobError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "getBlobError"));

    unexpectedInternalError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "unexpectedInternalError"));
    AmberUnavailableError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "AmberUnavailableError"));
    operationTimedOutError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "operationTimedOutError"));
    invalidBlobIdError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "invalidBlobIdError"));
    invalidPutArgumentError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "invalidPutArgumentError"));
    insufficientCapacityError =
        registry.counter(MetricRegistry.name(AmberCoordinator.class, "insufficientCapacityError"));
    blobTooLargeError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "blobTooLargeError"));
    blobAlreadyExistsInLocalColoError =
        registry.counter(MetricRegistry.name(AmberCoordinator.class, "blobAlreadyExistsInLocalColoError"));
    blobAlreadyExistsInRemoteColoError =
        registry.counter(MetricRegistry.name(AmberCoordinator.class, "blobAlreadyExistsInRemoteColoError"));
    blobDoesNotExistError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "blobDoesNotExistError"));
    blobDeletedError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "blobDeletedError"));
    blobExpiredError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "blobExpiredError"));
    unknownError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "unknownError"));
    corruptionError = registry.counter(MetricRegistry.name(AmberCoordinator.class, "corruptionError"));
    unknownReplicaResponseError =
        registry.counter(MetricRegistry.name(AmberCoordinator.class, "unknownReplicaResponseError"));
    successfulCrossColoProxyCallCount =
        registry.counter(MetricRegistry.name(AmberCoordinator.class, "successfulCrossColoProxyCallCount"));
    totalCrossColoProxyCallCount =
        registry.counter(MetricRegistry.name(AmberCoordinator.class, "totalCrossColoProxyCallCount"));
    ...
    plainTextConnectionsRequestRate =
        registry.meter(MetricRegistry.name(AmberCoordinator.class, "plainTextConnectionsRequestRate"));
    sslConnectionsRequestRate =
        registry.meter(MetricRegistry.name(AmberCoordinator.class, "sslConnectionsRequestRate"));
    ...
    if (!registry.getNames().contains(MetricRegistry.name(AmberCoordinator.class, "totalRequestsInFlight"))) {
      ...
      registry.register(MetricRegistry.name(AmberCoordinator.class, "totalRequestsInFlight"), requestsInFlight);
      ...
      registry.register(MetricRegistry.name(AmberCoordinator.class, "totalRequestsInExecution"), requestsInExecution);
    }
  }
  ...
  public void countError(CoordinatorOperationType operation, CoordinatorError error) {
    ...
    switch (error) {
      case UnexpectedInternalError:
        ...
        break;
      case AmberUnavailable:
        updateOperationMetric(operation);
        AmberUnavailableError.inc();
        break;
