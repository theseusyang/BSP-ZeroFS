...
/**
 * This is an Amber frontend specific implementation of {@link BlobStorageService}.
 * <p/>
 * All the operations that need to be performed by the Amber frontend are supported here.
 */
class AmberBlobStorageService implements BlobStorageService {
  ...
  private final Logger logger = LoggerFactory.getLogger(AmberBlobStorageService.class);
  ...
  /**
   * Create a new instance of AmberBlobStorageService by supplying it with config, metrics, cluster map, a
   ...
   */
  public AmberBlobStorageService(FrontendConfig frontendConfig, FrontendMetrics frontendMetrics,
    ...
    logger.trace("Instantiated AmberBlobStorageService");
  }
  ...
  public void start()
    ...
    isUp = true;
    logger.info("AmberBlobStorageService has started");
  ...
  public void shutdown() {
    ...
    try {
      ...
      logger.info("AmberBlobStorageService shutdown complete");
    } catch (IOException e) {
  ...
  /**
   * Checks if {@link AmberBlobStorageService} is available to serve requests.
   * @throws RestServiceException if {@link AmberBlobStorageService} is not available to serve requests.
   */
  private void checkAvailable()
      throws RestServiceException {
    if (!isUp) {
      throw new RestServiceException("AmberBlobStorageService unavailable", RestServiceErrorCode.ServiceUnavailable);
    }
  }
                ...
                if (securityException == null) {
                  if (subResource != null) {
                    ...
                    if (userMetadata == null) {
                      ...
                      response = new ByteBufferReadableStreamChannel(AmberBlobStorageService.EMPTY_BUFFER);
                    }
