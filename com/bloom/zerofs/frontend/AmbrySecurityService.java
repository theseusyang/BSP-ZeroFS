...
/**
 * Default implementation of {@link SecurityService} for Amber that doesn't do any validations, but just
 * sets the respective headers on response.
 */
class AmberSecurityService implements SecurityService {

  private boolean isOpen;
  private final FrontendConfig frontendConfig;
  private final FrontendMetrics frontendMetrics;

  public AmberSecurityService(FrontendConfig frontendConfig, FrontendMetrics frontendMetrics) {
  ...
  private void setBlobPropertiesHeaders(BlobProperties blobProperties, RestResponseChannel restResponseChannel)
    ...
    if (blobProperties.getContentType() != null) {
      restResponseChannel.setHeader(RestUtils.Headers.Amber_CONTENT_TYPE, blobProperties.getContentType());
    }
