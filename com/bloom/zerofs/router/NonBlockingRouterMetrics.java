...
public class NonBlockingRouterMetrics {
  ...
  public final Counter AmberUnavailableErrorCount;
  ...
  public NonBlockingRouterMetrics(ClusterMap clusterMap) {
    ...
    AmberUnavailableErrorCount =
        metricRegistry.counter(MetricRegistry.name(NonBlockingRouter.class, "AmberUnavailableErrorCount"));
   ...
   * {@link com.bloom.zerofs.router.NonBlockingRouter.OperationController}, to indicate if it is running
   * or not.
   ...
   * {@link com.bloom.zerofs.router.NonBlockingRouter.OperationController} of a {@link NonBlockingRouter}.
   * @param currentOperationsCount The counter of {@link com.bloom.zerofs.router.NonBlockingRouter.OperationController}.
   */
    ...
    if (exception instanceof RouterException) {
      switch (((RouterException) exception).getErrorCode()) {
        case AmberUnavailable:
          AmberUnavailableErrorCount.inc();
          break;
        case InvalidBlobId:
   ...
   * request to a {@link com.bloom.zerofs.clustermap.ReplicaId} in a {@link DataNodeId}. An operation request can be
